...
class TestEntities:
    ...
    async def test_upsert_and_get_entity(self, db, project_id):
        ...
        entity_id = await upsert_entity(db, project_id, name, entity_type, importance)
...
class TestObservations:
    ...
    async def test_add_and_get_observation(self, db, project_id):
        ...
        observation_id = await add_observation(db, entity_id, content)
...
class TestRelations:
    ...
    async def test_add_and_get_relation(self, db, project_id):
        ...
        relation_id = await add_relation(db, project_id, from_id, to_id, relation)
